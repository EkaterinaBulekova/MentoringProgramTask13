    ...
    public class AccountController : Controller
    {
        ...
        public AccountController()
            : this(new UserManager<ApplicationUser>(new UserStore<ApplicationUser>(new ApplicationDbContext())),
                new Logger(LogManager.GetLogger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType)))
        {
        }
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            if (ModelState.IsValid)
            {
                ...
                if (user != null)
                {
                    ...
                    _logger.Debug($"User {user.UserName} login successful");
                    CounterHelper.Increment(StoreCounters.LogInSuccess);
        ...
        public ActionResult LogOff()
        {
            ...
            _logger.Debug("User LogOff");
            CounterHelper.Increment(StoreCounters.LogOffSuccess);
            return RedirectToAction("Index", "Home");
        }
